...
INSERT INTO staff(username, password, firstname, lastname, email, telephone, avatar)
VALUES
('johnsmith', 'password123', 'John', 'Smith', 'john.smith@example.com', '123-456-7890', 'avatar/1.jpg'),
('janelee', 'password456', 'Jane', 'Lee', 'jane.lee@example.com', '456-789-0123', 'avatar/2.jpg'),
('michaelchen', 'password789', 'Michael', 'Chen', 'michael.chen@example.com', '789-012-3456', 'avatar/3.jpg'),
('sarahkim', 'password1234', 'Sarah', 'Kim', 'sarah.kim@example.com', '012-345-6789', 'avatar/4.jpg'),
('annazhang', 'password9012', 'Anna', 'Zhang', 'anna.zhang@example.com', '678-901-2345', 'avatar/6.jpg'),
('jameswang', 'password3456', 'James', 'Wang', 'james.wang@example.com', '901-234-5678', 'avatar/7.jpg'),
('susanliu', 'password7890', 'Susan', 'Liu', 'susan.liu@example.com', '234-567-8901', 'avatar/8.jpg'),
('peterwu', 'password2345', 'Peter', 'Wu', 'peter.wu@example.com', '567-890-1234', 'avatar/9.jpg'),
('pemilywang', 'password6789', 'Emily', 'Wang', 'emily.wang@example.com', '890-123-4567', 'avatar/10.jpg'),
('pstevenchen', 'password12345', 'Steven', 'Chen', 'steven.chen@example.com', '123-456-7890', 'avatar/11.jpg'),
('pgraceyang', 'password67890', 'Grace', 'Yang', 'grace.yang@example.com', '456-789-0123', 'avatar/12.jpg'),
('pbrianhu', 'password23456', 'Brian', 'Hu', 'brian.hu@example.com', '789-012-3456', 'avatar/13.jpg'),
('pjulielin', 'password78901', 'Julie', 'Lin', 'julie.lin@example.com', '012-345-6789', 'avatar/14.jpg'),
('poliverli', 'password123456', 'Oliver', 'Li', 'oliver.li@example.com', '345-678-9012', 'avatar/15.jpg'),
('pchriswang', 'password234567', 'Chris', 'Wang', 'chris.wang@example.com', '678-901-2345', 'avatar/16.jpg'),
('pmonicazhou', 'password890123', 'Monica', 'Zhou', 'monica.zhou@example.com', '901-234-5678', 'avatar/17.jpg'),
('pkevinli', 'password2345678', 'Kevin', 'Li', 'kevin.li@example.com', '234-567-8901', 'avatar/18.jpg'),
('phannahwang', 'password6789012', 'Hannah', 'Wang', 'hannah.wang@example.com', '567-890-1234', 'avatar/19.jpg'),
('pryanlee', 'password1234567', 'Ryan', 'Lee', 'ryan.lee@example.com', '890-123-4567', 'avatar/20.jpg');
